...
# Creates a k3d cluster and deploys the three-tier microservices application
#
# Prerequisites:
# - k3d installed
# - kubectl installed
...
check_prerequisites() {
    ...
    if ! command -v k3d &> /dev/null; then
        log_error "k3d is not installed. Install: https://k3d.io/stable/#installation"
        exit 1
    fi
    log_success "k3d found: $(k3d version | head -n 1)"
